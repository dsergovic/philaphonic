...
export const musicItems: MusicItem[] = [
  { id: "m1", kind: "latest", artist: "Mannequin Pussy", title: "I Got Heaven", genre: "Punk / Indie", blurb: "South Philly's loudest tender-hearts, still touring the record that put the city back on punk maps.", year: 2024, neighborhood: "South Philly", coverUrl: "/images/covers/punk.jpg" },
  { id: "m2", kind: "latest", artist: "Tierra Whack", title: "World Wide Whack", genre: "Hip-Hop", blurb: "North Philly's shapeshifter with a full-length as playful and unnerving as anything out of the city in years.", year: 2024, neighborhood: "North Philly", coverUrl: "/images/covers/hip-hop.jpg" },
  { id: "m3", kind: "latest", artist: "Alex G", title: "Headlights", genre: "Indie Rock", blurb: "Havertown's bedroom-pop auteur keeps mutating — warped tape hiss and melodies that won't leave you alone.", year: 2025, neighborhood: "Havertown", coverUrl: "/images/covers/indie-rock.jpg" },
  { id: "m4", kind: "classic", artist: "The O'Jays", title: "Back Stabbers", genre: "Philly Soul", blurb: "The Sound of Philadelphia, distilled: Gamble & Huff strings, Sigma Sound sheen, and harmonies for the ages.", year: 1972, neighborhood: "Sigma Sound, Center City", coverUrl: "/images/covers/classic-soul.jpg" },
  { id: "m5", kind: "latest", artist: "Snacktime", title: "Sound Bites", genre: "Brass / Funk", blurb: "The brass band that turned Kelly Drive park hangs into a movement — pure block-party energy.", year: 2024, neighborhood: "Fishtown", coverUrl: "/images/covers/neo-soul.jpg" },
  { id: "m6", kind: "latest", artist: "Armand Hammer x The Bul Bey", title: "City Cypher", genre: "Hip-Hop", blurb: "Underground bars over dusty loops — the corner-store cypher tradition is alive and well.", year: 2025, neighborhood: "West Philly", coverUrl: "/images/covers/hip-hop.jpg" },
  { id: "m7", kind: "classic", artist: "Hall & Oates", title: "Abandoned Luncheonette", genre: "Blue-Eyed Soul", blurb: "Two Temple kids and the smoothest record ever cut about a diner off Route 724.", year: 1973, neighborhood: "Temple / North Philly", coverUrl: "/images/covers/classic-soul.jpg" },
  { id: "m8", kind: "latest", artist: "Orion Sun", title: "Orange Skies", genre: "Neo-Soul / R&B", blurb: "Bedroom-soul warmth from a songwriter who makes the city's quiet hours feel cinematic.", year: 2025, neighborhood: "Germantown", coverUrl: "/images/covers/neo-soul.jpg" },
  { id: "m9", kind: "latest", artist: "Zahsosaa", title: "Corner Symphony", genre: "Philly Club", blurb: "Sneaker-squeak percussion and relentless BPM — Philly club keeps the dancefloors sweating.", year: 2025, neighborhood: "Southwest Philly", coverUrl: "/images/covers/hip-hop.jpg" },
  { id: "m10", kind: "classic", artist: "John Coltrane", title: "Giant Steps", genre: "Jazz", blurb: "Cut two years after he left his Strawberry Mansion rowhouse — the house still stands on 33rd Street.", year: 1960, neighborhood: "Strawberry Mansion", coverUrl: "/images/covers/jazz.jpg" },
  { id: "m11", kind: "latest", artist: "Japanese Breakfast", title: "For Melancholy Brunettes", genre: "Indie Pop", blurb: "Michelle Zauner's lush return — written between Seoul and the Philly suburbs that raised her.", year: 2025, neighborhood: "Bryn Mawr", coverUrl: "/images/covers/indie-rock.jpg" },
  { id: "m12", kind: "latest", artist: "Ivy Sole", title: "Golden Hour Freestyles", genre: "Hip-Hop / Soul", blurb: "West Philly wordplay with a warm center — Sunday-afternoon rap for row-home porches.", year: 2024, neighborhood: "West Philly", coverUrl: "/images/covers/neo-soul.jpg" },
  { id: "m13", kind: "classic", artist: "MFSB", title: "TSOP (The Sound of Philadelphia)", genre: "Philly Soul", blurb: "The house band, the anthem, the whole genre in three letters. Soul Train's theme was born here.", year: 1974, neighborhood: "Sigma Sound, Center City", coverUrl: "/images/covers/classic-soul.jpg" },
  { id: "m14", kind: "latest", artist: "2nd Grade", title: "Easy Listening Vol. 2", genre: "Power Pop", blurb: "Two-minute pop songs by the dozen — Philly's most reliable hooks-per-minute ratio.", year: 2024, neighborhood: "South Philly", coverUrl: "/images/covers/indie-rock.jpg" },
  { id: "m15", kind: "latest", artist: "Sug Daniels", title: "Franklin Delight", genre: "Soul / Folk", blurb: "Honeyed vocals and porch-light storytelling from one of the region's fastest-rising songwriters.", year: 2025, neighborhood: "Wilmington / Philly", coverUrl: "/images/covers/neo-soul.jpg" },
  { id: "m16", kind: "classic", artist: "The Roots", title: "Things Fall Apart", genre: "Hip-Hop", blurb: "Before the Tonight Show, there was Illadelph — the record that made organic hip-hop a Philly export.", year: 1999, neighborhood: "South Philly", coverUrl: "/images/covers/hip-hop.jpg" },
  { id: "m17", kind: "latest", artist: "Kississippi", title: "Mood Ring Redux", genre: "Indie Pop", blurb: "Glitter-coated heartbreak pop, made for singing alone on the El at midnight.", year: 2024, neighborhood: "Fishtown", coverUrl: "/images/covers/indie-rock.jpg" },
  { id: "m18", kind: "classic", artist: "Patti LaBelle", title: "Lady Marmalade", genre: "Soul / Funk", blurb: "The Godmother of Soul, Southwest Philly's own — still the standard for bringing the house down.", year: 1974, neighborhood: "Southwest Philly", coverUrl: "/images/covers/classic-soul.jpg" },
];
...
export function socialPosts(): SocialPost[] {
  return [
    { id: "s1", platform: "instagram", handle: "@phillyeatsdaily", displayName: "Philly Eats Daily", content: "Whiz wit at 1am hits different. This city never lets you down. #Philaphonic", imageUrl: "/images/social/cheesesteak.jpg", likes: 2841, comments: 163, postedAt: minsAgo(18), tag: "#PhillyEats" },
    ...
    { id: "s3", platform: "instagram", handle: "@rockystepsclub", displayName: "Rocky Steps Run Club", content: "6am crew earned this view. 72 steps, zero regrets. Every single sunrise is worth it.", imageUrl: "/images/social/rocky-steps.jpg", likes: 3390, comments: 214, postedAt: minsAgo(52), tag: "#RockySteps" },
    ...
    { id: "s5", platform: "instagram", handle: "@kfnshows", displayName: "KFN Shows", content: "Sold out basement show energy. Fishtown on a Tuesday night goes harder than most cities on a Saturday.", imageUrl: "/images/social/concert-crowd.jpg", likes: 1876, comments: 97, postedAt: minsAgo(84), tag: "#PhillyMusic" },
    ...
    { id: "s7", platform: "instagram", handle: "@muralmilephl", displayName: "Mural Mile PHL", content: "New wall alert in Brewerytown. The artist spent six weeks on the scaffolding and you can feel every day of it.", imageUrl: "/images/social/mural-selfie.jpg", likes: 2233, comments: 118, postedAt: minsAgo(126), tag: "#MuralArts" },
...
export const photos: Photo[] = [
  { id: "p1", title: "Blue Hour on the Skyline", location: "Schuylkill Banks", credit: "Philaphonic / M. Rivera", imageUrl: "/images/photos/skyline-dusk.jpg", tag: "skyline" },
  { id: "p2", title: "Boathouse Row Lights", location: "Kelly Drive", credit: "Philaphonic / J. Okafor", imageUrl: "/images/photos/boathouse-row.jpg", tag: "landmarks" },
  { id: "p3", title: "Six Stories of Color", location: "South Philadelphia", credit: "Philaphonic / D. Chen", imageUrl: "/images/photos/mural-arts.jpg", tag: "murals" },
  { id: "p4", title: "Ninth Street Morning", location: "Italian Market", credit: "Philaphonic / A. Santos", imageUrl: "/images/photos/italian-market.jpg", tag: "food" },
  { id: "p5", title: "America's Oldest Street", location: "Elfreth's Alley, Old City", credit: "Philaphonic / K. Boyle", imageUrl: "/images/photos/elfreths-alley.jpg", tag: "history" },
  { id: "p6", title: "October in the Park", location: "Fairmount Park", credit: "Philaphonic / L. Nguyen", imageUrl: "/images/photos/fairmount-park.jpg", tag: "nature" },
  { id: "p7", title: "Lunch Rush", location: "Reading Terminal Market", credit: "Philaphonic / T. Washington", imageUrl: "/images/photos/reading-terminal.jpg", tag: "food" },
  { id: "p8", title: "Midnight Green Sea", location: "Lincoln Financial Field", credit: "Philaphonic / R. Delgado", imageUrl: "/images/photos/stadium-night.jpg", tag: "sports" },
];
